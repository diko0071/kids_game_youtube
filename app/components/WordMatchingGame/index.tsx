...
export default function WordMatchingGame({ onComplete }: WordMatchingGameProps) {
    ...
    return (
        <div className="flex flex-col items-center justify-start bg-gradient-to-r from-purple-300 to-pink-300 p-4 rounded-lg w-[550px]">
            <div className="text-4xl font-bold mb-12 mt-12">
                {currentWord.russian}
            </div>
            <div className="grid grid-cols-2 gap-4 mb-8">
                {options.map((option) => (
                    <Button
                        ...
                        className="text-xl font-bold p-6 h-auto rounded-lg bg-white hover:bg-gray-100 text-purple-800"
                    >
                        {option}
                    </Button>
                ))}
